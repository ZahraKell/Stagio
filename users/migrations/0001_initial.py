    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pnum', models.CharField(blank=True, max_length=20, null=True)),
                ('role', models.CharField(choices=[('student', 'Student'), ('company', 'Company'), ('admin', 'Admin'), ('administration', 'Administration')], default='student', max_length=20)),
