...
# IMPORTANT:
# This file is a standalone HTTP integration script, not a Django unittest module.
# During `manage.py test`, Django imports files named `test*.py`; we skip this module
# on import so test discovery remains green.
if __name__ != "__main__":
    raise unittest.SkipTest(
        "Standalone integration script. Run directly: python test_stagio.py"
    )
