...
urlpatterns = [
    ...
    path(
        '<int:pk>/administration-review/',
        views.administration_review_application,
        name='administration-review-application',
    ),
    ...
    path('<int:pk>/upload-convention/', views.upload_convention),
    path('<int:pk>/upload-attestation/', views.upload_student_attestation),
