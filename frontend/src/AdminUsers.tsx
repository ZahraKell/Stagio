...
export default function AdminUsers() {
  ...
  const getMockUsers = (): User[] => [
    { id: 1, username: "ahmed.benali", email: "ahmed@esi.dz", full_name: "Ahmed Benali", role: "student", is_active: true, town: "Constantine" },
    { id: 2, username: "sara.meziane", email: "sara@usthb.dz", full_name: "Sara Meziane", role: "student", is_active: true, town: "Alger" },
    { id: 3, username: "karim.lounis", email: "karim@ummto.dz", full_name: "Karim Lounis", role: "student", is_active: true, town: "Tizi Ouzou" },
    { id: 4, username: "nadia.hamdi", email: "nadia@univ-alger.dz", full_name: "Nadia Hamdi", role: "student", is_active: true, town: "Alger" },
    { id: 5, username: "youcef.ould", email: "youcef@esi.dz", full_name: "Youcef Ould", role: "student", is_active: false, town: "Alger" },
    { id: 6, username: "sonatrach", email: "contact@sonatrach.dz", full_name: "Sonatrach", role: "company", is_active: true, town: "Alger" },
    { id: 7, username: "mobilis", email: "rh@mobilis.dz", full_name: "Mobilis", role: "company", is_active: true, town: "Alger" },
    { id: 8, username: "condor", email: "condor@condor.dz", full_name: "Condor Electronics", role: "company", is_active: false, town: "Bordj Bou Arreridj" },
    { id: 9, username: "admin1", email: "admin@stageconnect.dz", full_name: "Admin User", role: "admin", is_active: true, town: "Alger" },
    { id: 10, username: "univ.constantine", email: "admin@univ-constantine.dz", full_name: "Univ Constantine Admin", role: "administration", is_active: true, town: "Constantine" },
  ];
  ...
  return (
    <div className="am-page-root">
      ...
      <div className="am-page-header">
        <div>
          ...
          <p className="am-page-sub">
            {users.length} total users • {users.filter(u => u.role === "student").length} students • 
      ...
      <div className="am-filters-row">
        ...
        <span className="am-results-count">{filteredUsers.length} users found</span>
      </div>
                      ...
                      <div className="am-action-btns">
                        ...
                        {showDeleteConfirm === user.id ? (
                          <div className="am-delete-confirm">
                            ...
                            <button onClick={() => setShowDeleteConfirm(null)} className="am-btn-confirm-no">✕</button>
                          </div>
                        ) : (
                          <button
      ...
      {filteredUsers.length > 8 && (
        <div className="am-pagination">
          ...
          <button className="am-page-btn">2</button>
